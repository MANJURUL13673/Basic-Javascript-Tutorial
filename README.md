...
- const - this type of variable is constant. It can not reinitialize.<br>
For declarying string `''` and `""` both are acceptable.
<br>No need to worry about `;` int the last of line. JS gives flexibility to use this.
<br><b>File: variables.js</b>
